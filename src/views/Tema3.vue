  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="zoom-in-left")
      .titulo-principal__numero
        span 3
      h1 Los principales componentes del sistema de información
    ...
    p(data-aos="fade-down").mb-5 Por otro lado, es importante conocer que el código abierto, también conocido como Open Source, es un programa que se distribuye libremente y puede ser usado y modificado por los usuarios sin ninguna restricción. A continuación, presentamos el desarrollo que ha tenido el software de código abierto a través del tiempo.
    ...
    LineaTiempoE.color-acento-contenido.mb-5
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        ...
        .col-lg-10.mb-4.mb-lg-0
          p Richard Stallman es el fundador del movimiento por software libre, en el mundo. 
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        .col-lg-2
          img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/28.png', alt='')  
        .col-lg-10.mb-4.mb-lg-0
          p Comienzo de todo. La definición de fuente abierta es primero que los computadores y el mismo software surge de la filosofía de la cooperación y sinceridad.
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        .col-lg-2
          img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/29.png', alt='')  
        .col-lg-10.mb-4.mb-lg-0
          p Primeros sistemas operativos con código fuente para modificarlo; el software es producido en masa por académicos e investigadores corporativos, y el sistema operativo era distribuido y mantenido por las comunidades de usuarios. 
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        .col-lg-2
          img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/30.png', alt='')  
        .col-lg-10.mb-4.mb-lg-0
          p Se revela el nacimiento de Linux Torvalds, un sistema operativo completamente libre y gratuito.
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        .col-lg-2
          img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/31.png', alt='')  
        .col-lg-10.mb-4.mb-lg-0
          p Sistemas operativos primitivos. Se inicia la creación del software privativo, que es cerrado, no hay acceso al código fuente, solo su creador. Imposible su manipulación por parte del usuario.
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        .col-lg-2
          img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/32.png', alt='')  
        .col-lg-10.mb-4.mb-lg-0
          p Stallman ve la necesidad de modificar el código fuente. Se modifica el código fuente de algunos software, para que sean adaptados de acuerdo con la necesidad de los usuarios.
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        .col-lg-2
      ...
      .row(titulo="1983" subtitulo="")(data-aos="fade-left")
        ...
        .col-lg-10.mb-4.mb-lg-0
          p Creación de la fundación de software libre (FSF). Se crea la fundación de software libre y copyleft por Richard Stallman.
