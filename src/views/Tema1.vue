    ...
    .row.justify-content-center.align-items-center.mb-5           
      ...
      .col-lg-8
        TabsC.color-acento-botones.mb-5
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="Memoria RAM")
          ...
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="Memoria ROM")
        ...
        TabsC.color-acento-botones.mb-5            
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="CD-R/RW")
          ...
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="Blue Ray")
          ...
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="Unidad Zip")
          ...
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="Memoria Flash")
          ...
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="Tarjeta de memoria")
          ...
          .tarjeta.color-acento-botones--borde.p-4.mb-3(titulo="Almacenamiento en la nube")
